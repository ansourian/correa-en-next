      ...
      <section className="container-info_modelos fade-section">
        <article className="informacion-pantalla_modelos">
          ...
          <p className="p-info_modelos">
            La prueba consiste en tomar de nuestros clientes las medidas exactas
            para la fabricación a medida de su calzado. Altura, anchura y demás
            caracteristicas proyectan el futuro producto. Aquí es donde nuestro
            servicio está por sobre todo lo conocido. Como las mejores casas del
            mundo.
          </p>
        </article>
        <article className="informacion-pantalla_modelos">
          ...
          <p className="p-info_modelos">
            Es fundamental la elección de los materiales. Cueros Seleccionados y
            Materiales de calidad Premium confeccionan nuestros calzados. En
            nuestro Showroom podrá disfrutar además de un ambiente ameno,
            cordial y con aires de antaño, gran cantidad de "pies" exhibidos en
            nuestras vidrieras. Para los que se atrevan a más, existen líneas
            Trendy que combinan los diseños clásicos con colores de Tendencia.
          </p>
        </article>
        <article className="informacion-pantalla_modelos">
          ...
          <p className="p-info_modelos">
            ...
            principio confecciones exclusivas, e incorporar en su final acabados
            de lujo y detalles notables a la hora de coronar otra obra maestra
            de la casa.
          </p>
        </article>
        <article className="informacion-pantalla_modelos">
          ...
          <p className="p-info_modelos">
            ...
            alguna manera a Correa. Solo reparamos los zapatos que se adquieren
            en nuestros locales. Aquellos amantes del buen vestir y de la
            elegancia, al arribar al local ubicado en Mario Bravo al 750, no
            dejan de sorprenderse al descubrir el tratamiento y la confección
